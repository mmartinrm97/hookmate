...
- All 18 acceptance criteria (AC-01 through AC-18) pass
- Development checklist has ≥ 70 items checked
...
- `terraform/COMPARISON.md` documents key CDK vs Terraform differences
